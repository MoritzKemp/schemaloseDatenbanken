...
Um Ad-Hoc auf die Daten der Datenbank zuzugreifen, verwendet man das mitgelieferte Komanozilenprogramm \textbf{hbase shell}, welches in JRuby geschrieben wurde. Um das Tool aufzurufen navigiert man mittels:
\begin{lstlisting}[language=bash]
  $ cd hbase
\end{lstlisting}
