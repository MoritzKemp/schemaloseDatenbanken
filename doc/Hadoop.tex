...
Im Folgenden kapitel wird beschrieben, wie man Hadoop auf mehreren Knotten installiert.

Die Grundlage für eine lauffähige Hadoop Instanz ist die Java Laufzeitumgebung. Für Hadoop brauchen wir mind. Java Version 1.6.
Nach dem Java auf der dafür vorgesehenen Maschine installiert ist, muss man die JAVA_HOME auf das richtige Java Verzeichnis setzen.
Nachdem man die richtige Java Version installiert hat, kann man Hadoop auf der Seite von Apache Hadoop  (http://hadoop.apache.org/releases.html) downloaden und entpacken.
...
Sämtliche Konfigurationsparameter befinden sich in der Version 2.7.3 im folgenden Hadoop Verzeichnis: etc/hadoop/
...
Eine weitere wichtige Konfigurationsdatei core-site.xml beinhaltet das Verzeichnis und die Adresse des Hadoop-Dateisystems. Bei der frischen Hadoop Installation ist diese Datei leer um muss mit Inhalt befüllt werden.
