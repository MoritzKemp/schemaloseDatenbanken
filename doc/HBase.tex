...
Die Installation von ZooKeeper ist verhältnismäßig einfach. Nachdem die Anwendung auf die einzelnen Knoten herunter geladen ist, muss in der \texttt{zookeeper/conf/zoo.cfg}
...
\subsubsection{Konfiguration für das Projekt}

\lstset{basicstyle=\small}
\lstinputlisting{sourcecode/hbase-site.xml}
