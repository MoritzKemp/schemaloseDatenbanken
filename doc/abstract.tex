...
Im ersten Teil der Projektarbeit werden die technologischen Grundlagen MapReduce
behandelt.Die Theorie soll etwa ein Drittel der Projektarbeit ausmachen. Im zweiten Kapitel werden das NSQL-System HBase und das Framework Hadoop vorgestellt.

Der dritte Teil der Projektarbeit, zwei Drittel der Projektarbeit, beschreibt die praktische Umsetzung, die aus der Installation und 
...
um einen Überblick zu geben. Anschließend folgt ein Kapitel zur Installation bzw. Implementierung von
Hadoop/Hbase auf dem Cluster. Hier wird Schritt für Schritt das Vorgehen  beschrieben, wie die Installation und Konfiguration 
abläuft. %Eingesetzte Programmiersprache ist hier Java.
Fragestellungen werden sein, wie 
...
Implementierung von MapReduce-Funktionen wird in diesem Kapitel dargelegt. Des Weiteren werden Filter- und Optimierungsparameter,
